                    ...
                    <div class="card-body">
                      <form method="post" action="index.php">
                        <input type="hidden" name="controller" value="users">
                          ...
                          <?php if ($_SESSION['account'][0]['administrator'] == 1) : ?>
                          <div class="form-check">
                            <input type="radio" class="form-check-input" name="administrator" value="1">
                            <label class="form-check-label">Supper Admin</label>
                          </div>
                          <?php endif; ?>
